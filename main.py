...
parser.add_argument("--dataset", action="store", dest="dataset", default="04379243_table", help="The name of dataset")
...
parser.add_argument("--data_dir", action="store", dest="data_dir", default="./data/04379243_table", help="Root directory of dataset [data]")
